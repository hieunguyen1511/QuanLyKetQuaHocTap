...
namespace QuanLyKetQuaHocTap.Models
{
    public class General
    {
        ...
        public static string strDaHoanThanhDGRL = "Đã đánh giá", strChuaHoanThanhDGRL = "Chưa đánh giá";
        ...
        public static string getStrDecimal(int number, int size)
        {
        ...
        public static int getMaxIDHocPhan()
        {
            return db.tb_HocPhan.Max(n => n.ID);
        }

        public static List<tb_SinhVien> getDanhSachSV(int? id_nganh, int? id_hp)
        {
            return db.tb_SinhVien.Where(n => n.ID_Nganh == id_nganh && n.tb_DiemHocPhan.FirstOrDefault(s => s.ID_HocPhan == id_hp) == null).ToList();
        }
